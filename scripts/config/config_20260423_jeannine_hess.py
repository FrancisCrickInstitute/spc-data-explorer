...
class Config:
    ...
    if os.environ.get("USER", "") == "warchas":
        ...
        SPC_ANALYSIS_DIR = Path("/Path/to/your/spc/analysis/directory")
        
        # CellProfiler Analysis Directory
        CP_ANALYSIS_DIR = Path("/nemo/project/proj-prosperity/hts/raw/projects/20251111_gsk_prosperity_all_datasets/cellprofiler/processed_data/20260305_123039_results")
        ...
        # SPC Analysis Directory
        SPC_ANALYSIS_DIR = Path("/Path/to/your/spc/analysis/directory")  # UPDATE THIS PATH
        
        # CellProfiler Analysis Directory
        CP_ANALYSIS_DIR = Path("/Volumes/proj-prosperity/hts/raw/projects/20251111_gsk_prosperity_all_datasets/cellprofiler/processed_data/20260305_123039_results")
    ...
    SHOW_CHEMICAL_STRUCTURES = False  # Set to True to re-enable chemical structures

    # ============================================================================
    # DATA FILTERING
    # ============================================================================
    # Rows where Metadata_library matches any value in this list will be excluded.
    ...
    # FEATURE FLAGS
    # ============================================================================
    # Set to False to hide the Landmark Distance Analysis button and skip
    # registering its callbacks. Other configs can leave this out or set True.
    ENABLE_LANDMARK_ANALYSIS = False
