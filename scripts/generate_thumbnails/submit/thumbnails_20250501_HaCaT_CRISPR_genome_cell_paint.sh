...
# Output directory
OUTPUT_DIR="/nemo/project/proj-prosperity/hts/raw/projects/20250501_HaCaT_CRISPR_genome_cell_paint/data/images/thumbnails"
...
INPUT_DIRS=(
    "/nemo/project/proj-prosperity/hts/raw/projects/20250501_HaCaT_CRISPR_genome_cell_paint/data/images/max_projected_images"
)
