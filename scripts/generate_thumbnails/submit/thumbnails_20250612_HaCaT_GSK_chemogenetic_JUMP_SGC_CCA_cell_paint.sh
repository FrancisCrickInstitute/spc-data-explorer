...
# Output directory
OUTPUT_DIR="/nemo/project/proj-prosperity/hts/raw/projects/20250612_HaCaT_GSK_chemogenetic_JUMP_SGC_CCA_cell_paint/data/images/thumbnails"
...
INPUT_DIRS=(
    "/nemo/project/proj-prosperity/hts/raw/projects/20250612_HaCaT_GSK_chemogenetic_JUMP_SGC_CCA_cell_paint/data/images/max_projected_images"
)
